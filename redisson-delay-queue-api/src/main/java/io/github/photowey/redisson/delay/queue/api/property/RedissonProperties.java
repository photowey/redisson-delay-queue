 ...
 */
package io.github.photowey.redisson.delay.queue.api.property;

import io.github.photowey.redisson.delay.queue.core.enums.Redisson;
 ...
 * @since 2024/05/12
 */
//@ConfigurationProperties(prefix = "spring.redis.redisson.delayqueue")
public class RedissonProperties implements Serializable {
    ...
    private Redisson.Redis.Mode mode = Redisson.Redis.Mode.SINGLE;
    ...
    public static String getPrefix() {
        return "spring.redis.redisson.delayqueue";
    }
    ...
    public static class ServerConfig implements Serializable {
        ...
        public void setMode(Redisson.Redis.Mode mode) {
            this.mode = mode;
        }
        ...
        public Redisson.Redis.Mode getMode() {
            return mode;
        }
    ...
    public Redisson.Redis.Mode mode() {
        return mode;
    }
