...
/**
 * {@code DefaultTopicDelayedQueueEventListener}
 *
 * @author photowey
 * @version 1.0.0
 * @since 2024/05/13
 */
@Slf4j
public class DefaultTopicDelayedQueueEventListener implements DelayedQueueEventListener {
    ...
    public void handle(TaskContext<?> ctx) {
        ...
        log.info("json.generic: default.topic.listener:[{}:{}]", ctx.taskId(), JSON.Jackson.toJSONString(payload));
    }
}