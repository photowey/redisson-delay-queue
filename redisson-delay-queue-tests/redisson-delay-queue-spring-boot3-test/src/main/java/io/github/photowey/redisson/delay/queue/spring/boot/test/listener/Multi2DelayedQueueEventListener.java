...
/**
 * {@code Multi2DelayedQueueEventListener}
 *
 * @author photowey
 * @version 1.0.0
 * @since 2024/05/13
 */
@Slf4j
public class Multi2DelayedQueueEventListener implements DelayedQueueEventListener {
    ...
    public void handle(TaskContext<?> ctx) {
        ...
        log.info("json.generic: custom.topic.multi2.listener:[{}:{}]", ctx.taskId(), JSON.Jackson.toJSONString(payload));
    }
}